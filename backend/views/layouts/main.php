				...
				<div class="top-menu">
					<ul class="nav navbar-nav pull-right">
								...
								<li>
									<div class="slimScrollDiv"
										...
										<ul class="dropdown-menu-list scroller"
											...
											<li><a href="javascript:;"> <span class="time">3 mins</span>
													<span class="details"> <span
											...
											<li><a href="javascript:;"> <span class="time">14 hrs</span>
													<span class="details"> <span
											...
											<li><a href="javascript:;"> <span class="time">2 days</span>
													<span class="details"> <span
														class="label label-sm label-icon label-danger"> <i
															class="fa fa-bolt"></i>
											...
											<li><a href="javascript:;"> <span class="time">3 days</span>
													<span class="details"> <span
														class="label label-sm label-icon label-danger"> <i
															class="fa fa-bolt"></i>
											...
											<li><a href="javascript:;"> <span class="time">4 days</span>
													<span class="details"> <span
														class="label label-sm label-icon label-warning"> <i
															class="fa fa-bell-o"></i>
											...
											<li><a href="javascript:;"> <span class="time">5 days</span>
													<span class="details"> <span
														class="label label-sm label-icon label-info"> <i
															class="fa fa-bullhorn"></i>
													</span> System Error.
											...
											<li><a href="javascript:;"> <span class="time">9 days</span>
													<span class="details"> <span
														class="label label-sm label-icon label-danger"> <i
															class="fa fa-bolt"></i>
						...
						<li class="dropdown dropdown-extended dropdown-inbox"
							...
							class="dropdown-toggle" data-toggle="dropdown"
							data-hover="dropdown" data-close-others="true"
							aria-expanded="false"> <i class="icon-envelope-open"></i> <span
									...
									<div class="slimScrollDiv"
										...
										<ul class="dropdown-menu-list scroller"
											...
											<li><a href="#"> <span class="photo"> <img
														src="/admin/css/assets/layouts/layout3/img/avatar2.jpg"
														class="img-circle" alt="">
												</span> <span class="subject"> <span class="from"> Lisa Wong
													</span> <span class="time">Just Now </span>
												</span> <span class="message"> Vivamus sed auctor nibh
														congue nibh. auctor nibh auctor nibh... </span>
											</a></li>
											<li><a href="#"> <span class="photo"> <img
														src="/admin/css/assets/layouts/layout3/img/avatar3.jpg"
														class="img-circle" alt="">
												</span> <span class="subject"> <span class="from"> Richard
															Doe </span> <span class="time">16 mins </span>
												</span> <span class="message"> Vivamus sed congue nibh
														auctor nibh congue nibh. auctor nibh auctor nibh... </span>
											</a></li>
											<li><a href="#"> <span class="photo"> <img
														src="/admin/css/assets/layouts/layout3/img/avatar1.jpg"
														class="img-circle" alt="">
											...
											<li><a href="#"> <span class="photo"> <img
													...
													</span> <span class="time">40 mins </span>
											...
											<li><a href="#"> <span class="photo"> <img
														...
														class="img-circle" alt="">
															...
															Doe </span> <span class="time">46 mins </span>
												</span> <span class="message"> Vivamus sed congue nibh
														auctor nibh congue nibh. auctor nibh auctor nibh... </span>
											</a></li>
										</ul>
						...
						<li class="dropdown dropdown-extended dropdown-tasks"
							...
							class="dropdown-toggle" data-toggle="dropdown"
							data-hover="dropdown" data-close-others="true"
							aria-expanded="false"> <i class="icon-calendar"></i> <span
								...
								<li>
									<div class="slimScrollDiv"
										...
										<ul class="dropdown-menu-list scroller"
											style="height: 275px; overflow: hidden; width: auto;"
											data-handle-color="#637283" data-initialized="1">
											<li><a href="javascript:;"> <span class="task"> <span
														class="desc">New release v1.2 </span> <span
											...
											<li><a href="javascript:;"> <span class="task"> <span
														class="desc">New UI release</span> <span class="percent">38%</span>
						...
						<li class="dropdown dropdown-extended quick-sidebar-toggler"><span
							class="sr-only">Toggle Quick Sidebar</span> <i
							class="icon-logout"></i></li>
			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu"
					...
					<li class="nav-item"><a href="javascript:;"
						...
						<ul class="sub-menu" style="display: none;">
							<li class="nav-item  "><a href="ui_colors.html" class="nav-link ">
									<span class="title">Color Library</span>
							</a></li>
							<li class="nav-item  "><a href="ui_general.html"
								class="nav-link "> <span class="title">General Components</span>
							</a></li>
							...
							<li class="nav-item  "><a href="ui_confirmations.html"
								class="nav-link "> <span class="title">Popover Confirmations</span>
							</a></li>
							<li class="nav-item  "><a href="ui_icons.html" class="nav-link ">
							...
							<li class="nav-item  "><a href="ui_tabs_accordions_navs.html"
								class="nav-link "> <span class="title">Tabs, Accordions &amp;
										Navs</span>
							</a></li>
							<li class="nav-item  "><a href="ui_timeline.html"
								class="nav-link "> <span class="title">Timeline</span>
							</a></li>
							<li class="nav-item  "><a href="ui_tree.html" class="nav-link ">
									<span class="title">Tree View</span>
							</a></li>
							<li class="nav-item  "><a href="javascript:;"
								class="nav-link nav-toggle"> <span class="title">Page Progress
										Bar</span> <span class="arrow"></span>
							</a>
								<ul class="sub-menu">
									<li class="nav-item "><a href="ui_page_progress_style_1.html"
										class="nav-link "> Flash </a></li>
									<li class="nav-item "><a href="ui_page_progress_style_2.html"
										class="nav-link "> Big Counter </a></li>
								</ul></li>
							...
							<li class="nav-item  "><a href="ui_bootstrap_growl.html"
								class="nav-link "> <span class="title">Bootstrap Growl
										Notifications</span>
							</a></li>
							<li class="nav-item  "><a href="ui_notific8.html"
								class="nav-link "> <span class="title">Notific8 Notifications</span>
							</a></li>
							<li class="nav-item  "><a href="ui_toastr.html" class="nav-link ">
									<span class="title">Toastr Notifications</span>
							</a></li>
							<li class="nav-item  "><a href="ui_bootbox.html"
								class="nav-link "> <span class="title">Bootbox Dialogs</span>
							</a></li>
							<li class="nav-item  "><a href="ui_alerts_api.html"
								class="nav-link "> <span class="title">Metronic Alerts API</span>
							</a></li>
							<li class="nav-item  "><a href="ui_session_timeout.html"
								class="nav-link "> <span class="title">Session Timeout</span>
							</a></li>
							<li class="nav-item  "><a href="ui_idle_timeout.html"
								class="nav-link "> <span class="title">User Idle Timeout</span>
							</a></li>
							<li class="nav-item  "><a href="ui_modals.html" class="nav-link ">
									<span class="title">Modals</span>
							</a></li>
							<li class="nav-item  "><a href="ui_extended_modals.html"
								class="nav-link "> <span class="title">Extended Modals</span>
							</a></li>
							<li class="nav-item  "><a href="ui_tiles.html" class="nav-link ">
						...
						<ul class="sub-menu">
							<li class="nav-item  "><a
								href="components_date_time_pickers.html" class="nav-link "> <span
									class="title">Date &amp; Time Pickers</span>
							</a></li>
							<li class="nav-item  "><a href="components_color_pickers.html"
								class="nav-link "> <span class="title">Color Pickers</span>
							</a></li>
							<li class="nav-item  "><a href="components_select2.html"
								class="nav-link "> <span class="title">Select2 Dropdowns</span>
							</a></li>
							<li class="nav-item  "><a href="components_bootstrap_select.html"
								class="nav-link "> <span class="title">Bootstrap Select</span>
							</a></li>
							<li class="nav-item  "><a href="components_multi_select.html"
								class="nav-link "> <span class="title">Multi Select</span>
							</a></li>
							<li class="nav-item  "><a
								href="components_bootstrap_select_splitter.html"
								class="nav-link "> <span class="title">Select Splitter</span>
							</a></li>
							<li class="nav-item  "><a href="components_typeahead.html"
								class="nav-link "> <span class="title">Typeahead Autocomplete</span>
							</a></li>
							<li class="nav-item  "><a
								href="components_bootstrap_tagsinput.html" class="nav-link "> <span
									class="title">Bootstrap Tagsinput</span>
							</a></li>
							<li class="nav-item  "><a href="components_bootstrap_switch.html"
								class="nav-link "> <span class="title">Bootstrap Switch</span>
							</a></li>
							<li class="nav-item  "><a
								href="components_bootstrap_maxlength.html" class="nav-link "> <span
									class="title">Bootstrap Maxlength</span>
							</a></li>
							<li class="nav-item  "><a
								href="components_bootstrap_fileinput.html" class="nav-link "> <span
									class="title">Bootstrap File Input</span>
							</a></li>
							<li class="nav-item  "><a
								href="components_bootstrap_touchspin.html" class="nav-link "> <span
									class="title">Bootstrap Touchspin</span>
							</a></li>
							<li class="nav-item  "><a href="components_form_tools.html"
								class="nav-link "> <span class="title">Form Widgets &amp; Tools</span>
							</a></li>
							<li class="nav-item  "><a href="components_context_menu.html"
								class="nav-link "> <span class="title">Context Menu</span>
							</a></li>
							<li class="nav-item  "><a href="components_editors.html"
								class="nav-link "> <span class="title">Markdown &amp; WYSIWYG
										Editors</span>
							</a></li>
							<li class="nav-item  "><a href="components_code_editors.html"
								class="nav-link "> <span class="title">Code Editors</span>
							</a></li>
							<li class="nav-item  "><a href="components_ion_sliders.html"
								class="nav-link "> <span class="title">Ion Range Sliders</span>
							</a></li>
							<li class="nav-item  "><a href="components_noui_sliders.html"
								class="nav-link "> <span class="title">NoUI Range Sliders</span>
							</a></li>
							<li class="nav-item  "><a href="components_knob_dials.html"
								class="nav-link "> <span class="title">Knob Circle Dials</span>
							</a></li>
						</ul></li>
					<li class="nav-item  "><a href="javascript:;"
						...
						<ul class="sub-menu">
							<li class="nav-item  "><a href="form_controls.html"
								class="nav-link "> <span class="title">Bootstrap Form <br>Controls
								</span>
							</a></li>
							<li class="nav-item  "><a href="form_controls_md.html"
								class="nav-link "> <span class="title">Material Design <br>Form
										Controls
								</span>
							</a></li>
							<li class="nav-item  "><a href="form_icheck.html"
								class="nav-link "> <span class="title">iCheck Controls</span>
							</a></li>
							...
							<li class="nav-item  "><a href="form_editable.html"
								class="nav-link "> <span class="title">Form X-editable</span>
							</a></li>
							...
							<li class="nav-item  "><a href="form_fileupload.html"
								class="nav-link "> <span class="title">Multiple File Upload</span>
							</a></li>
							<li class="nav-item  "><a href="form_dropzone.html"
								class="nav-link "> <span class="title">Dropzone File Upload</span>
							</a></li>
						</ul></li>
					<li class="nav-item  "><a href="javascript:;"
						...
						<ul class="sub-menu">
							<li class="nav-item  "><a href="javascript:;"
								class="nav-link nav-toggle"> <span class="title">Static Tables</span>
							...
							<li class="nav-item  "><a href="javascript:;"
								...
								<ul class="sub-menu">
									<li class="nav-item "><a href="table_datatables_managed.html"
										class="nav-link "> Managed Datatables </a></li>
									<li class="nav-item "><a href="table_datatables_buttons.html"
									...
									<li class="nav-item "><a href="table_datatables_scroller.html"
									...
									<li class="nav-item "><a href="table_datatables_editable.html"
					...
					<li class="nav-item  "><a href="?p=" class="nav-link nav-toggle"> <i
							class="icon-wallet"></i> <span class="title">Portlets</span> <span
							class="arrow"></span>
					</a>
						<ul class="sub-menu">
							...
							<li class="nav-item  "><a href="portlet_draggable.html"
								class="nav-link "> <span class="title">Draggable Portlets</span>
							</a></li>
						</ul></li>
					<li class="nav-item  "><a href="javascript:;"
						...
						<ul class="sub-menu">
							...
							<li class="nav-item  "><a href="charts_flotcharts.html"
								class="nav-link "> <span class="title">Flotchart</span>
							</a></li>
							<li class="nav-item  "><a href="charts_flowchart.html"
								class="nav-link "> <span class="title">Flowchart</span>
							</a></li>
						</ul></li>
					<li class="nav-item  "><a href="javascript:;"
					...
					<li class="nav-item  "><a href="javascript:;"
						...
						<ul class="sub-menu">
							<li class="nav-item  "><a href="layout_language_bar.html"
								class="nav-link "> <span class="title">Header Language Bar</span>
							</a></li>
					...
					<li class="nav-item  "><a href="javascript:;"
						...
						<ul class="sub-menu">
							<li class="nav-item  "><a href="layout_sidebar_menu_hover.html"
								class="nav-link "> <span class="title">Hover Sidebar Menu</span>
							</a></li>
							<li class="nav-item  "><a href="layout_sidebar_reversed.html"
								class="nav-link "> <span class="title">Reversed Sidebar Page</span>
							</a></li>
							<li class="nav-item  "><a href="layout_sidebar_fixed.html"
								class="nav-link "> <span class="title">Fixed Sidebar Layout</span>
							</a></li>
							<li class="nav-item  "><a href="layout_sidebar_closed.html"
								class="nav-link "> <span class="title">Closed Sidebar Layout</span>
							</a></li>
						</ul></li>
					<li class="nav-item  "><a href="javascript:;"
						...
						<ul class="sub-menu">
							<li class="nav-item  "><a href="layout_disabled_menu.html"
								class="nav-link "> <span class="title">Disabled Menu Links</span>
							</a></li>
						</ul></li>
					<li class="heading">
					...
					<li class="nav-item  "><a href="javascript:;"
						...
						<ul class="sub-menu">
							...
							<li class="nav-item  "><a href="ecommerce_orders_view.html"
								class="nav-link "> <i class="icon-tag"></i> <span class="title">Order
										View</span>
							</a></li>
							...
							<li class="nav-item  "><a href="ecommerce_products_edit.html"
								class="nav-link "> <i class="icon-graph"></i> <span
									class="title">Product Edit</span>
							</a></li>
						</ul></li>
					<li class="nav-item  "><a href="javascript:;"
						...
						<ul class="sub-menu">
							<li class="nav-item  "><a href="app_todo.html" class="nav-link ">
									<i class="icon-clock"></i> <span class="title">Todo 1</span>
							</a></li>
							<li class="nav-item  "><a href="app_todo_2.html"
								class="nav-link "> <i class="icon-check"></i> <span
									class="title">Todo 2</span>
							</a></li>
							<li class="nav-item  "><a href="app_inbox.html" class="nav-link ">
									<i class="icon-envelope"></i> <span class="title">Inbox</span>
							</a></li>
					...
					<li class="nav-item  "><a href="javascript:;"
						...
						<ul class="sub-menu">
							<li class="nav-item  "><a href="page_user_profile_1.html"
								class="nav-link "> <span class="title">Profile 1</span>
							</a></li>
							<li class="nav-item  "><a href="page_user_profile_1_account.html"
								class="nav-link "> <span class="title">Profile 1 Account</span>
							</a></li>
							<li class="nav-item  "><a href="page_user_profile_1_help.html"
								class="nav-link "> <span class="title">Profile 1 Help</span>
							</a></li>
							<li class="nav-item  "><a href="page_user_profile_2.html"
								class="nav-link "> <span class="title">Profile 2</span>
							</a></li>
							<li class="nav-item  "><a href="page_user_login_1.html"
								class="nav-link " target="_blank"> <span class="title">Login
										Page 1</span>
							</a></li>
							...
							<li class="nav-item  "><a href="page_user_lock_1.html"
								class="nav-link " target="_blank"> <span class="title">Lock
										Screen 1</span>
							</a></li>
					...
					<li class="nav-item  "><a href="javascript:;"
						...
						<ul class="sub-menu">
							...
							<li class="nav-item  "><a href="page_system_404_2.html"
								class="nav-link " target="_blank"> <span class="title">404 Page
										2</span>
							</a></li>
							...
							<li class="nav-item  "><a href="page_system_500_2.html"
								class="nav-link " target="_blank"> <span class="title">500 Page
										2</span>
							</a></li>
						</ul></li>
					<li class="nav-item"><a href="javascript:;"
						...
						<ul class="sub-menu">
							<li class="nav-item"><a href="javascript:;"
								class="nav-link nav-toggle"> <i class="icon-settings"></i> Item
									1 <span class="arrow"></span>
							</a>
								<ul class="sub-menu">
									<li class="nav-item"><a href="?p=dashboard-2" target="_blank"
						...
						<div class="portlet light bordered">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-bar-chart font-green"></i> <span
										class="caption-subject font-green bold uppercase">Site Visits</span>
									<span class="caption-helper">weekly stats...</span>
								</div>
								<div class="actions">
									<div class="btn-group btn-group-devided" data-toggle="buttons">
										<label class="btn red btn-outline btn-circle btn-sm active"> <input
							...
							<div class="portlet-body">
								<div id="site_statistics_loading" style="display: none;">
									<img src="/admin/css/assets/global/img/loading.gif" alt="loading">
								</div>
								<div id="site_statistics_content" class="display-none"
									style="display: block;">
									<div id="site_statistics" class="chart"
										style="padding: 0px; position: relative;">
										<canvas class="flot-base" width="470" height="300"
											style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 470px; height: 300px;"></canvas>
										<div class="flot-text"
											style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);">
											<div class="flot-x-axis flot-x1-axis xAxis x1Axis"
												style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;">
												<div
													style="position: absolute; max-width: 83px; top: 285px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 10px; text-align: center;">02/2013</div>
												<div
													style="position: absolute; max-width: 83px; top: 285px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 62px; text-align: center;">03/2013</div>
												<div
													style="position: absolute; max-width: 83px; top: 285px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 115px; text-align: center;">04/2013</div>
												<div
													style="position: absolute; max-width: 83px; top: 285px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 167px; text-align: center;">05/2013</div>
												<div
													style="position: absolute; max-width: 83px; top: 285px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 219px; text-align: center;">06/2013</div>
												<div
													style="position: absolute; max-width: 83px; top: 285px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 271px; text-align: center;">07/2013</div>
												<div
													style="position: absolute; max-width: 83px; top: 285px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 324px; text-align: center;">08/2013</div>
												<div
													style="position: absolute; max-width: 83px; top: 285px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 376px; text-align: center;">09/2013</div>
												<div
													style="position: absolute; max-width: 83px; top: 285px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 428px; text-align: center;">10/2013</div>
											</div>
											<div class="flot-y-axis flot-y1-axis yAxis y1Axis"
												style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;">
												<div
													style="position: absolute; top: 273px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 20px; text-align: right;">0</div>
												<div
													style="position: absolute; top: 220px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 1px; text-align: right;">1000</div>
												<div
													style="position: absolute; top: 166px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 1px; text-align: right;">2000</div>
												<div
													style="position: absolute; top: 113px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 1px; text-align: right;">3000</div>
												<div
													style="position: absolute; top: 59px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 1px; text-align: right;">4000</div>
												<div
													style="position: absolute; top: 6px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 1px; text-align: right;">5000</div>
											</div>
										</div>
										<canvas class="flot-overlay" width="470" height="300"
											style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 470px; height: 300px;"></canvas>
									</div>
								</div>
							</div>
						...
						<div class="portlet light bordered">
								...
								<div class="actions">
									<div class="btn-group">
										<a href=""
											...
											data-toggle="dropdown" data-hover="dropdown"
											data-close-others="true" aria-expanded="false"> Filter Range
							...
							<div class="portlet-body">
								...
								<div id="site_activities_content" class="display-none"
									style="display: block;">
									<div id="site_activities"
										style="height: 228px; padding: 0px; position: relative;">
										<canvas class="flot-base" width="470" height="228"
											style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 470px; height: 228px;"></canvas>
										<div class="flot-text"
											style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);">
											<div class="flot-x-axis flot-x1-axis xAxis x1Axis"
												style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;">
												<div
													style="position: absolute; max-width: 74px; top: 209px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 18px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 21px; text-align: center;">DEC</div>
												<div
													style="position: absolute; max-width: 74px; top: 209px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 18px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 69px; text-align: center;">JAN</div>
												<div
													style="position: absolute; max-width: 74px; top: 209px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 18px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 116px; text-align: center;">FEB</div>
												<div
													style="position: absolute; max-width: 74px; top: 209px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 18px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 161px; text-align: center;">MAR</div>
												<div
													style="position: absolute; max-width: 74px; top: 209px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 18px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 211px; text-align: center;">APR</div>
												<div
													style="position: absolute; max-width: 74px; top: 209px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 18px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 257px; text-align: center;">MAY</div>
												<div
													style="position: absolute; max-width: 74px; top: 209px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 18px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 306px; text-align: center;">JUN</div>
												<div
													style="position: absolute; max-width: 74px; top: 209px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 18px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 355px; text-align: center;">JUL</div>
												<div
													style="position: absolute; max-width: 74px; top: 209px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 18px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 399px; text-align: center;">AUG</div>
												<div
													style="position: absolute; max-width: 74px; top: 209px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 18px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 449px; text-align: center;">SEP</div>
											</div>
											<div class="flot-y-axis flot-y1-axis yAxis y1Axis"
												style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;">
												<div
													style="position: absolute; top: 197px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 20px; text-align: right;">0</div>
												<div
													style="position: absolute; top: 149px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 7px; text-align: right;">500</div>
												<div
													style="position: absolute; top: 100px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 1px; text-align: right;">1000</div>
												<div
													style="position: absolute; top: 52px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 1px; text-align: right;">1500</div>
												<div
													style="position: absolute; top: 3px; font-style: normal; font-variant: small-caps; font-weight: 400; font-stretch: normal; font-size: 11px; line-height: 14px; font-family: 'Open Sans', sans-serif; color: rgb(111, 123, 138); left: 1px; text-align: right;">2000</div>
											</div>
										</div>
										<canvas class="flot-overlay" width="470" height="228"
											style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 470px; height: 228px;"></canvas>
									</div>
								</div>
						...
						<div class="portlet light bordered">
							...
							<div class="portlet-body">
								<div class="slimScrollDiv"
														...
														<div class="cont-col2">
															<div class="desc">
																New order received with <span
																	class="label label-sm label-success"> Reference Number:
																	DR23923 </span>
															</div>
														</div>
													</div>
									...
									<div class="slimScrollBar"
										style="width: 7px; position: absolute; top: 76px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 186.335px; background: rgb(187, 187, 187);"></div>
									<div class="slimScrollRail"
										style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; opacity: 0.2; z-index: 90; right: 1px; background: rgb(234, 234, 234);"></div>
								</div>
							...
							<div class="portlet-body">
								<div class="task-content">
									<div class="slimScrollDiv"
										...
										<div class="scroller"
											style="height: 312px; overflow: hidden; width: auto;"
											...
											<ul class="task-list">
												<li>
													<div class="task-checkbox">
														<div class="checker">
															<span><input type="checkbox" class="liChild" value=""></span>
														</div>
													</div>
										...
										<div class="slimScrollBar"
											style="width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 271.153px; background: rgb(187, 187, 187);"></div>
										<div class="slimScrollRail"
											style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; opacity: 0.2; z-index: 90; right: 1px; background: rgb(234, 234, 234);"></div>
									</div>
								</div>
							...
							<div class="portlet-title">
								...
								<div class="tools">
									...
									<a href="#portlet-config" data-toggle="modal" class="config"
										data-original-title="" title=""> </a> <a href=""
										class="reload" data-original-title="" title=""> </a> <a
										href="" class="remove" data-original-title="" title=""> </a>
								</div>
							</div>
							<div class="portlet-body">
								<div class="row">
							...
							<div class="portlet-title">
								...
								<div class="actions">
									<a class="btn btn-circle btn-icon-only btn-default"
										...
										href="javascript:;" data-original-title="" title=""> </a> <a
								...
								<div id="region_statistics_content" class="display-none"
									...
									<div class="btn-toolbar margin-bottom-10">
										...
										<div class="btn-group pull-right">
											...
											<ul class="dropdown-menu pull-right">
												<li><a href="javascript:;" id="regional_stat_world"> World </a>
												</li>
												<li><a href="javascript:;" id="regional_stat_usa"> USA </a>
												</li>
												<li><a href="javascript:;" id="regional_stat_europe"> Europe
												</a></li>
												<li><a href="javascript:;" id="regional_stat_russia"> Russia
												</a></li>
									...
									<div id="vmap_world" class="vmaps display-none"
										style="width: 470px; display: block; position: relative; overflow: hidden;">
										<svg width="470" height="300">
											<g
												transform="scale(0.49473684210526314) translate(0, 28.191489361702125)">
											<path
												...
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b4d794"
												original="#b4d794" id="jqvmap1_id" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_pg" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b3d695"
												original="#b3d695" id="jqvmap1_mx" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ee" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6d993"
												original="#b6d993" id="jqvmap1_dz" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ma" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_mr" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ci" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ml" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_bf" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d993"
												original="#b5d993" id="jqvmap1_ng" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_tn" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ly" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d993"
												original="#b5d993" id="jqvmap1_eg" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_td" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_sd" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_et" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap1_so" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ye" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_cf" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_st" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_gq" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ga" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_cg" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ao" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_cd" class="jvectormap-region"></path>
											<path
												d="M537.82,339.9l2.81,2.59l-0.12,2.77l-4.36,0.09v-3.06L537.82,339.9L537.82,339.9z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_rw" class="jvectormap-region"></path>
											<path
												d="M536.21,346.21l4.27-0.09l-1.11,3.74l-1.08,0.94h-1.32l-0.94-2.53L536.21,346.21L536.21,346.21z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_bi" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ug" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ke" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_tz" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_zm" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_mw" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_mz" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_zw" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_na" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_bw" class="jvectormap-region"></path>
											<path
												d="M540.87,414l-2.51,0.42l-1.08,2.95l1.92,1.75h2.33l1.97-2.83L540.87,414L540.87,414z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_sz" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ls" class="jvectormap-region"></path>
											<path
												d="M534.16,403.63l-7.9,7.3l-1.88,4.51l-6.26-0.78l-5.21,4.63l-3.46-0.34l0.28-6.4l-1.23-0.43l-0.86,13.09l-6.14-0.06l-1.85-2.18l-2.71-0.03l2.47,7.09l4.41,4.17l-3.15,3.67l2.04,4.6l4.72,1.8l3.76-3.2l10.77,0.06l0.77-0.96l4.78-0.84l16.17-16.1l-0.06-5.07l-1.73,2.24h-2.59l-3.15-2.64l1.6-3.98l2.75-0.56l-0.25-8.18L534.16,403.63L534.16,403.63z M530.37,422.13l1.51-0.06l2.45,2.66l-0.07,3.08l-2.87,1.45l-0.18,1.02l-4.38,0.05l-1.37-3.3l1.25-2.42L530.37,422.13L530.37,422.13z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d894"
												original="#b5d894" id="jqvmap1_za" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap1_gl" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b3d595"
												original="#b3d595" id="jqvmap1_au" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_sb" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_vu" class="jvectormap-region"></path>
											<path
												d="M948.62,412.29l-1.24,1.66l-0.1,1.87l1.44,1.46L948.62,412.29L948.62,412.29z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_fj" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6d993"
												original="#b6d993" id="jqvmap1_ph" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#a7c29e"
												original="#a7c29e" id="jqvmap1_cn" class="jvectormap-region"></path>
											<path
												d="M787.46,248.31l-3.54,2.7l-0.19,5.2l3.06,3.56l0.76-0.67L787.46,248.31L787.46,248.31z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d894"
												original="#b5d894" id="jqvmap1_tw" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#a8c39d"
												original="#a8c39d" id="jqvmap1_jp" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b2d496"
												original="#b2d496" id="jqvmap1_ru" class="jvectormap-region"
												fill-opacity="1"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#909cae"
												original="#909cae" id="jqvmap1_us" class="jvectormap-region"></path>
											<path
												d="M613.01,398.99l-1.52,1.99l0.3,2.15l3.2-2.61L613.01,398.99L613.01,398.99z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_mu" class="jvectormap-region"></path>
											<path
												d="M607.38,402.37l-2.28,0.15l-0.15,1.99l1.52,0.31l2.28-1.07L607.38,402.37L607.38,402.37z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap1_re" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_mg" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_km" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_sc" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_mv" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_cv" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ht" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap1_fk" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_is" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d894"
												original="#b5d894" id="jqvmap1_no" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_lk" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap1_cu" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_bs" class="jvectormap-region"></path>
											<path
												d="M238.93,279.59l-3.48,0.88v0.97l2.03,1.17h2.13l1.35-1.56L238.93,279.59L238.93,279.59z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_jm" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_ec" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b2d396"
												original="#b2d396" id="jqvmap1_ca" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_gt" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_pa" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d994"
												original="#b5d994" id="jqvmap1_co" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d994"
												original="#b5d994" id="jqvmap1_ve" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_gy" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_sr" class="jvectormap-region"></path>
											<path
												d="M302.13,321.8l5.85,3.65l-3.06,6.08l-1.11,1.4l-3.25-1.87l0.09-6.55L302.13,321.8L302.13,321.8z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap1_gf" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6d993"
												original="#b6d993" id="jqvmap1_pe" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_bo" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_py" class="jvectormap-region"></path>
											<path
												d="M300.36,431.93l-2.05,2.19l0.85,11.78l6.44,1.87l8.19-8.21L300.36,431.93L300.36,431.93z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_uy" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d994"
												original="#b5d994" id="jqvmap1_ar" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d993"
												original="#b5d993" id="jqvmap1_cl" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b1d197"
												original="#b1d197" id="jqvmap1_br" class="jvectormap-region"></path>
											<path
												d="M204.56,282.4l-0.05,3.65h0.84l2.86-5.34h-1.94L204.56,282.4L204.56,282.4z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_bz" class="jvectormap-region"></path>
											<path
												d="M673.8,170.17l5.82-7.72l6.99,3.23l4.75,1.27l5.82-5.34l-3.95-2.91l2.6-3.67l7.76,2.74l2.69,4.41l4.86,0.13l2.54-1.89l5.23-0.21l1.14,1.94l8.69,0.44l5.5-5.61l7.61,0.8l-0.44,7.64l3.33,0.76l4.09-1.86l4.33,2.14l-0.1,1.08l-3.14,0.09l-3.27,6.86l-2.54,0.25l-9.88,12.91l-10.09,4.45l-6.31,0.49l-5.24-3.38l-6.7,3.58l-6.6-2.05l-1.87-4.79l-12.5-0.88l-6.4-10.85l-3.11-0.2L673.8,170.17L673.8,170.17z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_mn" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap1_kp" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b3d695"
												original="#b3d695" id="jqvmap1_kr" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6d993"
												original="#b6d993" id="jqvmap1_kz" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap1_tm" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_uz" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_tj" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_kg" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_af" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6d993"
												original="#b6d993" id="jqvmap1_pk" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_bd" class="jvectormap-region"></path>
											<path
												d="M729.44,303.65l-2.77-4.44l2.01-2.82l-1.9-3.49l-1.79-0.34l-0.34-5.86l-2.68-5.19l-0.78,1.24l-1.79,3.04l-2.24,0.34l-1.12-1.47l-0.56-3.95l-1.68-3.16l-6.84-6.45l1.68-1.11l0.31-4.67l2.5-4.2l1.08-10.45l3.62-2.47l0.12-3.81l2.17,0.72l3.42,4.95l-2.54,5.44l1.71,4.27l4.23,1.66l0.77,4.65l5.68,0.88l-1.57,2.71l-7.16,2.82l-0.78,4.62l5.26,6.76l0.22,3.61l-1.23,1.24l0.11,1.13l3.92,5.75l0.11,5.97L729.44,303.65L729.44,303.65z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_mm" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d994"
												original="#b5d994" id="jqvmap1_th" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_kh" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_la" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_az" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d994"
												original="#b5d994" id="jqvmap1_ir" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b4d794"
												original="#b4d794" id="jqvmap1_tr" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d894"
												original="#b5d894" id="jqvmap1_sa" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_sy" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_iq" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b0d097"
												original="#b0d097" id="jqvmap1_gb" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d993"
												original="#b5d993" id="jqvmap1_ie" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d894"
												original="#b5d894" id="jqvmap1_se" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d993"
												original="#b5d993" id="jqvmap1_fi" class="jvectormap-region"></path>
											<path
												d="M518.07,151.37l-6.85-1.11l0.15,3.83l6.35,3.88l2.6-0.76l-0.15-2.92L518.07,151.37L518.07,151.37z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_lv" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_lt" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_by" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d894"
												original="#b5d894" id="jqvmap1_pl" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b1d197"
												original="#b1d197" id="jqvmap1_it" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#afcf98"
												original="#afcf98" id="jqvmap1_fr" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b4d794"
												original="#b4d794" id="jqvmap1_nl" class="jvectormap-region"></path>
											<path
												d="M461.61,176.52l-0.64,1.6l6.88,4.54l1.98,0.47l0.07-2.15l-1.73-1.94h-1.06l-1.45-1.65L461.61,176.52L461.61,176.52z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d894"
												original="#b5d894" id="jqvmap1_be" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#adcc99"
												original="#adcc99" id="jqvmap1_de" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d994"
												original="#b5d994" id="jqvmap1_dk" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_sk" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d894"
												original="#b5d894" id="jqvmap1_at" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6d993"
												original="#b6d993" id="jqvmap1_hu" class="jvectormap-region"></path>
											<path
												d="M494.8,191.99l-2.54,1.52l-4.74,1.04l0.95,2.74l3.32,0.04l3.06-2.56L494.8,191.99L494.8,191.99z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_si" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6d993"
												original="#b6d993" id="jqvmap1_ua" class="jvectormap-region"></path>
											<path
												d="M520.75,187.71l3.1,4.77l-0.26,2.7l1.11,0.05l2.63-4.45l-3.16-3.92l-1.79-0.74L520.75,187.71L520.75,187.71z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_md" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6d993"
												original="#b6d993" id="jqvmap1_ro" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap1_rs" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d994"
												original="#b5d994" id="jqvmap1_gr" class="jvectormap-region"></path></g></svg>
										<div class="jqvmap-zoomin">+</div>
										<div class="jqvmap-zoomout">−</div>
									</div>
									<div id="vmap_usa" class="vmaps display-none"
										style="width: 470px; display: none; position: relative; overflow: hidden;">
										<svg width="470" height="300">
											<g
												transform="scale(0.4900938477580814) translate(0, 9.563829787233978)">
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_hi" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_ak" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_fl" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_nh" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_mi" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_vt" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_me" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_ri" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_ny" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_pa" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_nj" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#adcc99"
												original="#adcc99" id="jqvmap2_de" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_md" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_va" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_wv" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_oh" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b2d496"
												original="#b2d496" id="jqvmap2_in" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d993"
												original="#b5d993" id="jqvmap2_il" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_ct" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_wi" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_nc" class="jvectormap-region"></path>
											<path
												d="m803.44,248.16c2.67,3.43 3.85,-1.02 0.55,-0.75l-0.29,0.4 -0.25,0.35z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_dc" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_ma" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_tn" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d994"
												original="#b5d994" id="jqvmap2_ar" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_mo" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_ga" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_sc" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_ky" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_al" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_la" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_ms" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_ia" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_mn" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_ok" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_tx" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_nm" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_ks" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_ne" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_sd" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_nd" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_wy" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_mt" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b5d994"
												original="#b5d994" id="jqvmap2_co" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b4d794"
												original="#b4d794" id="jqvmap2_id" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_ut" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap2_az" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_nv" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_or" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap2_wa" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b2d396"
												original="#b2d396" id="jqvmap2_ca" class="jvectormap-region"></path></g></svg>
										<div class="jqvmap-zoomin">+</div>
										<div class="jqvmap-zoomout">−</div>
									</div>
									<div id="vmap_europe" class="vmaps display-none"
										...
										<svg width="470" height="300">
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap3_tn" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap3_jo" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#afcf98"
												original="#afcf98" id="jqvmap3_fr" class="jvectormap-region"></path>
											<path
												d="m296.51,373.48c1.45,1.4 -0.83,3.11 -0.11,0.58 0.04,-0.19 0.08,-0.38 0.11,-0.58z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap3_li" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b2d496"
												original="#b2d496" id="jqvmap3_ru" class="jvectormap-region"></path>
											<path
												d="m343.65,509.08c-1.52,-0.23 -1.75,-0.24 0,0z m1.95,2.72c-1.32,-0.63 -1.5,-0.7 0,0z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap3_mt" class="jvectormap-region"></path>
											<path
												d="m385.29,433.13c-1.98,-1.45 -3.12,-5.3 -6.16,-4.27 -0.68,-0.6 -0.46,-1.87 -1.44,-2.17 0.16,-1.66 0.06,-3.3 -0.89,-4.86 1.96,-1.05 1.28,-4.74 3.12,-5.09 1.81,3.01 2.14,-1.15 0.71,-2.43 2.24,-0.2 3.4,-2.11 5.57,-0.36 3.49,0.56 2.95,4.72 6.22,5.9 -2.5,0.45 -0.84,6.17 -3.72,4.67 0.19,-3.37 -2.81,0.5 -2.99,1.87 -0.8,1.83 -2.3,3.26 -0.46,4.87 0.08,0.47 0.4,1.59 0.03,1.87z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap3_me" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap3_rs" class="jvectormap-region"></path></g></svg>
										<div class="jqvmap-zoomin">+</div>
										<div class="jqvmap-zoomout">−</div>
									</div>
									<div id="vmap_russia" class="vmaps display-none"
										...
										<svg width="470" height="300">
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap4_rz" class="jvectormap-region"></path>
											<path
												d="m112.77,279.43-1.6964,2.1429-0.35714,1.7857-0.80358,0.89286-2.6786,0.98214-1.875,0.44643-1.5178,0.71429-0.71429,1.4286,0,2.1429,0.26786,2.3214-0.71429,1.875-1.5179,0.53571-0.44642,1.4286-0.44643,1.6964-0.625,1.1607,0.08928,0.625,2.3214,2.1429,2.2321,2.1429,1.6072,2.2321,1.4286,2.0536,0.98214,0,2.1429,0,1.9643-1.25,2.5-1.25,1.6964-1.0714,4.0179-0.26785,1.0714-0.98215v-3.6607c0-0.35714,0.0893-2.3214,0.0893-2.3214l1.5179-1.1607s0.71429-0.71429,0.80357-1.0714c0.0893-0.35714-0.26785-4.6429-0.26785-4.6429l1.4286-1.0714-0.80357-2.1428-1.7857-1.4286-2.3214,0.26786-0.89285,0.625-1.1607-0.80357-0.89286-1.3393v-1.3393l-1.875-0.80357h-1.3393l-0.89286-1.0714-0.26786-1.3393z"
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#c6c6c6"
												original="#c6c6c6" id="jqvmap4_tb" class="jvectormap-region"></path>
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap4_kn" class="jvectormap-region"></path>
											<path
											...
											<path
												...
												stroke="#333333" stroke-width="1" stroke-linecap="round"
												stroke-linejoin="round" stroke-opacity="0.5" fill="#b6da93"
												original="#b6da93" id="jqvmap4_ma" class="jvectormap-region"></path>
											<path
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab_1_1">
										<div class="slimScrollDiv"
											...
											<div class="scroller"
												style="height: 339px; overflow: hidden; width: auto;"
												data-always-visible="1" data-rail-visible="0"
												data-initialized="1">
												<ul class="feeds">
													<li>
											...
											<div class="slimScrollBar"
												style="width: 7px; position: absolute; top: 37px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 184.464px; background: rgb(187, 187, 187);"></div>
											<div class="slimScrollRail"
												style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; opacity: 0.2; z-index: 90; right: 1px; background: rgb(234, 234, 234);"></div>
										</div>
									</div>
									...
									<div class="fc-toolbar">
										...
										<div class="fc-right">
											<div class="fc-button-group">
												...
												<button type="button"
													class="fc-month-button fc-button fc-state-default fc-state-active">month</button>
												<button type="button"
																				...
																				<tbody>
																					<tr>
																						...
																						<td class="fc-event-container"><a
																							...
																							style="background-color: #F8CB00"><div
																									class="fc-content">
																			...
																			<table>
																				<tbody>
																					<tr>
																						...
																						<td
																							class="fc-day fc-widget-content fc-mon fc-past"
																							data-date="2016-04-11"></td>
																						<td
																							class="fc-day fc-widget-content fc-tue fc-past"
																							data-date="2016-04-12"></td>
																						<td
																							class="fc-day fc-widget-content fc-wed fc-past"
																							data-date="2016-04-13"></td>
																						<td
																							class="fc-day fc-widget-content fc-thu fc-past"
																							data-date="2016-04-14"></td>
																						<td
																							class="fc-day fc-widget-content fc-fri fc-past"
																							data-date="2016-04-15"></td>
																						<td
																							class="fc-day fc-widget-content fc-sat fc-past"
																							data-date="2016-04-16"></td>
																					</tr>
																				</tbody>
																			</table>
																		</div>
																			...
																			<table>
																				<thead>
																					<tr>
																						...
																						<td class="fc-day-number fc-mon fc-past"
																							data-date="2016-04-11">11</td>
																						<td class="fc-day-number fc-tue fc-past"
																							data-date="2016-04-12">12</td>
																						<td class="fc-day-number fc-wed fc-past"
																							data-date="2016-04-13">13</td>
																						<td class="fc-day-number fc-thu fc-past"
																							data-date="2016-04-14">14</td>
																						<td class="fc-day-number fc-fri fc-past"
																							data-date="2016-04-15">15</td>
																						<td class="fc-day-number fc-sat fc-past"
																							data-date="2016-04-16">16</td>
																					</tr>
																				</thead>
																				<tbody>
																					<tr>
																						...
																						<td class="fc-event-container" colspan="3"><a
																							class="fc-day-grid-event fc-h-event fc-event fc-start fc-end fc-draggable"
																							style="background-color: #89C4F4"><div
																									class="fc-content">
																									<span class="fc-time">12a</span> <span
																					...
																					<tr>
																						...
																						<td class="fc-event-container"><a
																							class="fc-day-grid-event fc-h-event fc-event fc-start fc-end fc-draggable"
																							style="background-color: #F3565D"><div
																									class="fc-content">
																					...
																					<tr>
																						...
																						<td class="fc-event-container"><a
																							...
																							style="background-color: #95a5a6"><div
																									class="fc-content">
																									<span class="fc-time">2p</span> <span
																				...
																				<tbody>
																					<tr>
																						<td
																							...
																							data-date="2016-04-24"></td>
																						<td
																							class="fc-day fc-widget-content fc-mon fc-future"
																							data-date="2016-04-25"></td>
																						<td
																							class="fc-day fc-widget-content fc-tue fc-future"
																							data-date="2016-04-26"></td>
																						<td
																							class="fc-day fc-widget-content fc-wed fc-future"
																							data-date="2016-04-27"></td>
																						<td
																							class="fc-day fc-widget-content fc-thu fc-future"
																							data-date="2016-04-28"></td>
																						<td
																							class="fc-day fc-widget-content fc-fri fc-future"
																							data-date="2016-04-29"></td>
																						<td
																							class="fc-day fc-widget-content fc-sat fc-future"
																							data-date="2016-04-30"></td>
																					</tr>
																				</tbody>
																			</table>
																		</div>
																				...
																				<thead>
																					<tr>
																						<td class="fc-day-number fc-sun fc-future"
																							data-date="2016-04-24">24</td>
																						<td class="fc-day-number fc-mon fc-future"
																							data-date="2016-04-25">25</td>
																						<td class="fc-day-number fc-tue fc-future"
																							data-date="2016-04-26">26</td>
																						<td class="fc-day-number fc-wed fc-future"
																							data-date="2016-04-27">27</td>
																						<td class="fc-day-number fc-thu fc-future"
																							data-date="2016-04-28">28</td>
																						<td class="fc-day-number fc-fri fc-future"
																							data-date="2016-04-29">29</td>
																						<td class="fc-day-number fc-sat fc-future"
																							data-date="2016-04-30">30</td>
																					</tr>
																				</thead>
																				<tbody>
																					<tr>
																						...
																						<td class="fc-event-container" rowspan="2"><a
																							class="fc-day-grid-event fc-h-event fc-event fc-start fc-end fc-draggable"
																							style="background-color: #1bbc9b"><div
																									class="fc-content">
																									<span class="fc-time">4p</span> <span
																										class="fc-title">Repeating Event</span>
																								</div></a></td>
						...
						<div class="portlet light bordered">
							...
							<div class="portlet-body" id="chats">
								<div class="slimScrollDiv"
									...
									<div class="scroller"
										style="height: 525px; overflow: hidden; width: auto;"
										data-always-visible="1" data-rail-visible1="1"
										data-initialized="1">
										<ul class="chats">
											<li class="out"><img class="avatar" alt=""
												src="/admin/css/assets/layouts/layout/img/avatar2.jpg">
												<div class="message">
													<span class="arrow"> </span> <a href="javascript:;"
														class="name"> Lisa Wong </a> <span class="datetime"> at
														20:11 </span> <span class="body"> Lorem ipsum dolor sit
											...
											<li class="in"><img class="avatar" alt=""
												src="/admin/css/assets/layouts/layout/img/avatar1.jpg">
												<div class="message">
													<span class="arrow"> </span> <a href="javascript:;"
														class="name"> Bob Nilson </a> <span class="datetime"> at
														20:30 </span> <span class="body"> Lorem ipsum dolor sit
														amet, consectetuer adipiscing elit, sed diam nonummy nibh
														euismod tincidunt ut laoreet dolore magna aliquam erat
														volutpat. </span>
												</div></li>
											...
											<li class="out"><img class="avatar" alt=""
												src="/admin/css/assets/layouts/layout/img/avatar3.jpg">
												<div class="message">
													<span class="arrow"> </span> <a href="javascript:;"
														class="name"> Richard Doe </a> <span class="datetime"> at
														20:33 </span> <span class="body"> Lorem ipsum dolor sit
														amet, consectetuer adipiscing elit, sed diam nonummy nibh
														euismod tincidunt ut laoreet dolore magna aliquam erat
														volutpat. </span>
												</div></li>
											<li class="in"><img class="avatar" alt=""
												...
												<div class="message">
													<span class="arrow"> </span> <a href="javascript:;"
														class="name"> Richard Doe </a> <span class="datetime"> at
														20:35 </span> <span class="body"> Lorem ipsum dolor sit
														amet, consectetuer adipiscing elit, sed diam nonummy nibh
														euismod tincidunt ut laoreet dolore magna aliquam erat
														volutpat. </span>
												</div></li>
											<li class="out"><img class="avatar" alt=""
												...
												<div class="message">
													<span class="arrow"> </span> <a href="javascript:;"
														class="name"> Bob Nilson </a> <span class="datetime"> at
														20:40 </span> <span class="body"> Lorem ipsum dolor sit
														amet, consectetuer adipiscing elit, sed diam nonummy nibh
														euismod tincidunt ut laoreet dolore magna aliquam erat
														volutpat. </span>
												</div></li>
											...
											<li class="out"><img class="avatar" alt=""
												...
												<div class="message">
													<span class="arrow"> </span> <a href="javascript:;"
														class="name"> Bob Nilson </a> <span class="datetime"> at
														20:54 </span> <span class="body"> Lorem ipsum dolor sit
														amet, consectetuer adipiscing elit, sed diam nonummy nibh
														euismod tincidunt ut laoreet dolore magna aliquam erat
									...
									<div class="slimScrollBar"
										style="width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 376.023px; background: rgb(187, 187, 187);"></div>
									<div class="slimScrollRail"
										style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; opacity: 0.2; z-index: 90; right: 1px; background: rgb(234, 234, 234);"></div>
								</div>
								<div class="chat-form">
									...
									<div class="btn-cont">
										<span class="arrow"> </span> <a href=""
											class="btn blue icn-only"> <i class="fa fa-check icon-white"></i>
										</a>
									</div>
								</div>
							</div>
			...
			<div class="page-quick-sidebar">
				...
				<div class="tab-content">
					<div class="tab-pane active page-quick-sidebar-chat"
						...
						<div class="page-quick-sidebar-list"
							...
							<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
								data-wrapper-class="page-quick-sidebar-list" data-height="337"
								data-initialized="1"
								style="overflow: hidden; width: auto; height: 337px;">
								...
								<ul class="media-list list-items">
									<li class="media">
										...
										src="/admin/css/assets/layouts/layout/img/avatar3.jpg" alt="...">
									...
									<li class="media"><img class="media-object"
										src="/admin/css/assets/layouts/layout/img/avatar1.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										src="/admin/css/assets/layouts/layout/img/avatar4.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media"><img class="media-object"
										src="/admin/css/assets/layouts/layout/img/avatar2.jpg" alt="...">
										<div class="media-body">
								...
								<ul class="media-list list-items">
									<li class="media">
										...
										src="/admin/css/assets/layouts/layout/img/avatar6.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										src="/admin/css/assets/layouts/layout/img/avatar7.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media"><img class="media-object"
										src="/admin/css/assets/layouts/layout/img/avatar8.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										src="/admin/css/assets/layouts/layout/img/avatar9.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media"><img class="media-object"
										src="/admin/css/assets/layouts/layout/img/avatar10.jpg" alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										src="/admin/css/assets/layouts/layout/img/avatar11.jpg" alt="...">
										<div class="media-body">
							...
							<div class="slimScrollBar"
								style="width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 130.09px; background: rgb(187, 187, 187);"></div>
							<div class="slimScrollRail"
								style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; opacity: 0.2; z-index: 90; right: 1px; background: rgb(221, 221, 221);"></div>
						</div>
						<div class="page-quick-sidebar-item">
							<div class="page-quick-sidebar-chat-user">
								...
								<div class="slimScrollDiv"
									style="position: relative; overflow: hidden; width: auto; height: 232px;">
									<div class="page-quick-sidebar-chat-user-messages"
										data-height="232" data-initialized="1"
										style="overflow: hidden; width: auto; height: 232px;">
										<div class="post out">
										...
										<div class="post in">
											...
											<div class="message">
												...
												<span class="body"> Its almost done. I will be sending it
													shortly </span>
											</div>
										</div>
										<div class="post out">
									...
									<div class="slimScrollBar"
										style="width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 79.6213px; background: rgb(187, 187, 187);"></div>
									<div class="slimScrollRail"
										style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; opacity: 0.2; z-index: 90; right: 1px; background: rgb(234, 234, 234);"></div>
								</div>
					...
					<div class="tab-pane page-quick-sidebar-alerts"
						...
						<div class="slimScrollDiv"
							style="position: relative; overflow: hidden; width: auto; height: 412px;">
							<div class="page-quick-sidebar-alerts-list" data-height="412"
								data-initialized="1"
								style="overflow: hidden; width: auto; height: 412px;">
					...
					<div class="tab-pane page-quick-sidebar-settings"
						...
						<div class="slimScrollDiv"
							style="position: relative; overflow: hidden; width: auto; height: 412px;">
							<div class="page-quick-sidebar-settings-list" data-height="412"
								data-initialized="1"
								style="overflow: hidden; width: auto; height: 412px;">
								...
								<ul class="list-items borderless">
									<li>Enable Notifications
										<div
											class="bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-on bootstrap-switch-small">
									...
									<li>Allow Tracking
										<div
											class="bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-off bootstrap-switch-small">
											<div class="bootstrap-switch-container">
												<span
